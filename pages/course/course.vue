<template>
	<view class="page">
		...
		<view class="tabs">
			<u-tabs :list="tabsList" :current="tabIndex" lineColor="#2979ff" :scrollable="false"
				:inactiveStyle="{color: '#303133'}" :activeStyle="{color: '#000000'}"
				:itemStyle="{flex: 1, height: '44px'}" @click="tabsClick"></u-tabs>
		</view>
		<swiper :style="{height: height}" :current="tabIndex" @change="swiperChange">
			<swiper-item v-for="(tab,i) in tabsList" :key="i">
				<mescroll-item ref="mescrollItem" :i="i" :index="tabIndex" :tabs="tabsList" :height="height"
					:keyword="keyword"></mescroll-item>
			</swiper-item>
		</swiper>

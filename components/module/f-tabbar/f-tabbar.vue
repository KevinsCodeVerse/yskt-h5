    ...
    data(){
        return {
            ...
            list:[{ 
                ...
                iconFill: '/static/index-fill.png'
            },
            {
                name: '课程',
                url: 'pages/course/course',
                icon: '/static/course.png',
                iconFill: '/static/course-fill.png',
            },
            {
                name: '作业圈',
                url: 'pages/workCircle/workCircle',
                icon: '/static/homework.png',
                iconFill: '/static/homework-fill.png',
            ...
            },
			{
			    ...
			    iconFill: '/static/personal-fill.png'
			}
			]
        }
    },
